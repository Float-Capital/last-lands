...
let db: Postgres.poolConfig = {
  ...
  port: envSafe->EnvSafe.get(~name="PG_PORT", ~struct=S.int()->S.Int.port(), ~devFallback=5433, ()),
  ...
  (
    "534351",
    {
      ...
      contracts: [
        {
          name: "NounsToken",
          abi: Abis.nounsTokenAbi->Ethers.makeAbi,
          addresses: [
            "0xDA27C0D5002DeCd0e3DF8C406F75ad74e4f96ED7"->Ethers.getAddressFromStringUnsafe,
          ],
          events: [NounsToken_NounCreated],
        },
      ],
    },
  ),
