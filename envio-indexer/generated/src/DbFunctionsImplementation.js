...
//////////////////////////////////////////////
// DB operations for GlobalState:
//////////////////////////////////////////////

module.exports.readGlobalStateEntities = (sql, entityIdArray) => sql`
SELECT 
"id",
"mintedLand",
"mintedLandIsoCodes"
FROM "public"."GlobalState"
WHERE id IN ${sql(entityIdArray)};`;

const batchSetGlobalStateCore = (sql, entityDataArray) => {
  return sql`
    INSERT INTO "public"."GlobalState"
${sql(entityDataArray,
    "id",
    "mintedLand",
    "mintedLandIsoCodes"
  ...
  SET
  "id" = EXCLUDED."id",
  "mintedLand" = EXCLUDED."mintedLand",
  "mintedLandIsoCodes" = EXCLUDED."mintedLandIsoCodes"
  `;
}

module.exports.batchSetGlobalState = (sql, entityDataArray) => {

  return chunkBatchQuery(
    sql, 
    entityDataArray, 
    batchSetGlobalStateCore
  );
}

module.exports.batchDeleteGlobalState = (sql, entityIdArray) => sql`
DELETE
FROM "public"."GlobalState"
WHERE id IN ${sql(entityIdArray)};`
// end db operations for GlobalState
